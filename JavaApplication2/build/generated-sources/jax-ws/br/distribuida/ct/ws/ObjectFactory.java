 ...
 * generated in the br.distribuida.ct.ws package. 
...
public class ObjectFactory {
    ...
    private final static QName _EhMinhaVez_QNAME = new QName("http://ws.ct.distribuida.br/", "ehMinhaVez");
    private final static QName _ObtemTabuleiroResponse_QNAME = new QName("http://ws.ct.distribuida.br/", "obtemTabuleiroResponse");
    private final static QName _TemPartida_QNAME = new QName("http://ws.ct.distribuida.br/", "temPartida");
    private final static QName _MovePecaResponse_QNAME = new QName("http://ws.ct.distribuida.br/", "movePecaResponse");
    private final static QName _RegistraJogador_QNAME = new QName("http://ws.ct.distribuida.br/", "registraJogador");
    private final static QName _EncerraPartida_QNAME = new QName("http://ws.ct.distribuida.br/", "encerraPartida");
    private final static QName _ObtemOponenteResponse_QNAME = new QName("http://ws.ct.distribuida.br/", "obtemOponenteResponse");
    private final static QName _ObtemOponente_QNAME = new QName("http://ws.ct.distribuida.br/", "obtemOponente");
    private final static QName _PosicionaPecaResponse_QNAME = new QName("http://ws.ct.distribuida.br/", "posicionaPecaResponse");
    private final static QName _PreRegistro_QNAME = new QName("http://ws.ct.distribuida.br/", "preRegistro");
    private final static QName _RegistraJogadorResponse_QNAME = new QName("http://ws.ct.distribuida.br/", "registraJogadorResponse");
    private final static QName _MovePeca_QNAME = new QName("http://ws.ct.distribuida.br/", "movePeca");
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://ws.ct.distribuida.br/", name = "ehMinhaVez")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://ws.ct.distribuida.br/", name = "obtemTabuleiroResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://ws.ct.distribuida.br/", name = "temPartida")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://ws.ct.distribuida.br/", name = "movePecaResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://ws.ct.distribuida.br/", name = "registraJogador")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://ws.ct.distribuida.br/", name = "encerraPartida")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://ws.ct.distribuida.br/", name = "obtemOponenteResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://ws.ct.distribuida.br/", name = "obtemOponente")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://ws.ct.distribuida.br/", name = "posicionaPecaResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://ws.ct.distribuida.br/", name = "preRegistro")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://ws.ct.distribuida.br/", name = "registraJogadorResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://ws.ct.distribuida.br/", name = "movePeca")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://ws.ct.distribuida.br/", name = "ehMinhaVezResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://ws.ct.distribuida.br/", name = "encerraPartidaResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://ws.ct.distribuida.br/", name = "obtemTabuleiro")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://ws.ct.distribuida.br/", name = "preRegistroResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://ws.ct.distribuida.br/", name = "temPartidaResponse")
